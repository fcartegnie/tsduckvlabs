...
namespace ts {
    ...
    //!
    TSDUCKDLL_INLINE inline uint32_t ROL(uint32_t word, int i) { return XX; }
    ...
    //! @return The value of @a word left-rotated by @a i bits.
    //!
    TSDUCKDLL_INLINE inline uint32_t ROLc(uint32_t word, const int i) { return XX; }
    ...
    //!
    TSDUCKDLL_INLINE inline uint32_t ROR(uint32_t word, int i) { return XX; }
    ...
    //! @return The value of @a word right-rotated by @a i bits.
    //!
    TSDUCKDLL_INLINE inline uint32_t RORc(uint32_t word, const int i) { return XX; }

#elif defined(TS_MSC)

    #pragma intrinsic(_lrotr,_lrotl)

    TSDUCKDLL_INLINE inline uint32_t ROL(uint32_t word, int i) { return _lrotl(word, i); }
    TSDUCKDLL_INLINE inline uint32_t ROR(uint32_t word, int i) { return _lrotr(word, i); }

    TSDUCKDLL_INLINE inline uint32_t ROLc(uint32_t word, const int i) { return _lrotl(word, i); }
    TSDUCKDLL_INLINE inline uint32_t RORc(uint32_t word, const int i) { return _lrotr(word, i); }

#elif defined(TS_GCC) && defined(TS_ARM64)

    TSDUCKDLL_INLINE inline uint32_t ROL(uint32_t word, int i)
    {
        asm("mov w8, #32 \n sub w8, w8, %w1 \n ror %w0, %w0, w8" : "+r" (word) : "r" (i) : "w8", "cc");
        return word;
    }

    TSDUCKDLL_INLINE inline uint32_t ROR(uint32_t word, int i)
    {
        asm("ror %w0, %w0, %w1" : "+r" (word) : "r" (i));
        return word;
    }

    TSDUCKDLL_INLINE inline uint32_t ROLc(uint32_t word, const int i)
    {
    #if defined(DEBUG)
        return ROL(word, i);
    #else
    ...
    TSDUCKDLL_INLINE inline uint32_t RORc(uint32_t word, const int i)
    {
    #if defined(DEBUG)
        return ROR(word, i);
    #else
    ...
    //! @return The value of @a word left-rotated by @a i bits.
    //!
    TSDUCKDLL_INLINE inline uint64_t ROL64(uint64_t word, int i) { return XX; }
    ...
    //! @return The value of @a word left-rotated by @a i bits.
    //!
    TSDUCKDLL_INLINE inline uint64_t ROL64c(uint64_t word, const int i) { return XX; }
    ...
    //! @return The value of @a word right-rotated by @a i bits.
    //!
    TSDUCKDLL_INLINE inline uint64_t ROR64(uint64_t word, int i) { return XX; }
    ...
    //! @return The value of @a word right-rotated by @a i bits.
    //!
    TSDUCKDLL_INLINE inline uint64_t ROR64c(uint64_t word, const int i) { return XX; }

#elif defined(TS_GCC) && defined(TS_ARM64)

    TSDUCKDLL_INLINE inline uint64_t ROL64(uint64_t word, int i)
    {
        asm("sub %1, %1, #64 \n neg %1, %1 \n ror %0, %0, %1" : "+r" (word) : "r" (uint64_t(i)));
        return word;
    }

    TSDUCKDLL_INLINE inline uint64_t ROR64(uint64_t word, int i)
    {
        asm("ror %0, %0, %1" : "+r" (word) : "r" (uint64_t(i)));
        return word;
    }

    TSDUCKDLL_INLINE inline uint64_t ROL64c(uint64_t word, const int i)
    {
    #if defined(DEBUG) || defined(TS_LLVM)
        return ROL64(word, i);
    #else
    ...
    TSDUCKDLL_INLINE inline uint64_t ROR64c(uint64_t word, const int i)
    {
    #if defined(DEBUG) || defined(TS_LLVM)
        return ROR64(word, i);
    #else
